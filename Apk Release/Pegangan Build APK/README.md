...
- [ ] **Unduhan APK** — `/gas/install` (dan EduLock bila diubah) menunjuk versi Final yang disepakati.
  - **GAS Siswa Final lokal terbaru** = **1.0.89-siswa (23086)** rebuild terbaru **2026-08-30 12:01**. Fokus patch: alur **Sekretaris Kelas** sekarang diperkuat menjadi **usulan -> verifikasi guru -> final**, sehingga sekretaris tidak bisa menetapkan hasil final sendiri dan tidak bisa mengabsenkan akun dirinya sendiri. File final aktif lokal: `Apk Release/Final/GAS-Siswa-release.apk` dan `Apk Release/Final/GAS-Siswa-1.0.89-siswa-23086.apk`. SHA256 alias final lokal `43A66518F381D9CFA99752C0977E604B5C183D163B4F3C2DCB8945480D4182DB`.
  ...
  - **GAS Guru Final saat ini** = **1.0.69-guru (1061)** rebuild terbaru **2026-08-30 12:01**. Mencakup hardening verifikasi presensi agar guru menjadi pengesah final untuk usulan `Sekretaris Kelas`, beserta badge audit yang lebih jelas di layar monitoring. File final aktif: `Apk Release/Final/GAS-Guru-release.apk` dan `Apk Release/Final/GAS-Guru-1.0.69-guru-1061.apk`. SHA256 alias final `7D91F1D13752871A6AC48F2878693CAE10ED6EF0F19AA93A919DA27048B4F127`.
