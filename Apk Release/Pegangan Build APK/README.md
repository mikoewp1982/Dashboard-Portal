...
- [ ] **Unduhan APK** — `/gas/install` (dan EduLock bila diubah) menunjuk versi Final yang disepakati.
  - **GAS Siswa Final lokal terbaru** = **1.0.84-siswa (23081)** rebuild terbaru **2026-08-29 pagi**. Fokus patch: logika `Virtual Pet` siswa sekarang memakai model **rekap harian hari sebelumnya**. Jadi 4 kartu aktivitas (`E-Perpus`, `7 KAIH`, `Kehadiran`, `Ibadah`) untuk **hari ini** baru dieksekusi menjadi nasib pet pada **00.00 hari berikutnya**, sehingga kasus pagi buta (`05.30`) pet langsung mati sebelum siswa sempat beraktivitas tidak terjadi lagi. File final aktif lokal: `Apk Release/Final/GAS-Siswa-release.apk` dan `Apk Release/Final/GAS-Siswa-1.0.84-siswa-23081.apk`. SHA256 alias final lokal `C6F1CBB088286BADE53A4557B0C3122BBED69164E12AEA555B663B98C39C5CA4`.
  ...
  - **GAS Guru Final saat ini** = **1.0.64-guru (1056)** rebuild terbaru **2026-08-29 pagi**. Mencakup parity alur **Presensi Siswa** agar data manual guru tetap sinkron ke `Rekap Bulanan` setelah disimpan, indikator visual pilihan di menu **Presensi Dhuha & Jum'at** yang lebih tegas (jejak centang + warna status), pengecilan ulang kartu menu Home guru, serta hardening loading awal agar UI guru tidak lagi sempat mem-flash potongan UI siswa sebelum sesi guru selesai terbaca. File final aktif: `Apk Release/Final/GAS-Guru-release.apk` dan `Apk Release/Final/GAS-Guru-1.0.64-guru-1056.apk`. SHA256 alias final `49CFFD991B264090F5C28549A79553842B11EA626591B2609A04F94556AFB3EA`.
