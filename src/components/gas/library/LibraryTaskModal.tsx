      ...
      <div className="w-full max-w-[560px] max-h-[92vh] rounded-xl border border-slate-700 bg-[#0f172a] shadow-2xl flex flex-col overflow-hidden">
        ...
        <div className="p-6 pt-4 space-y-4 overflow-y-auto">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                <label className="text-xs font-semibold text-slate-300">Jadwal Tugas (Opsional)</label>
                <span className="text-[11px] text-slate-400">Kosongkan jika tidak dibatasi waktu</span>
              </div>
              ...
              {invalidTimeRange && (
                <p className="text-[11px] text-red-400 font-medium">Waktu Selesai harus lebih besar dari Waktu Mulai.</p>
              )}
            </div>
        ...
        <div className="p-6 pt-2 flex justify-between gap-3 shrink-0 border-t border-slate-800">
          <button
            ...
            disabled={!title || isSubmitting || invalidTimeRange}
