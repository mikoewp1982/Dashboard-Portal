...
3. **Overlay Pet Mati di Rumah:** Tombol **"Saya Mengerti"** **MEMANG WAJIB BISA DIKLIK** untuk menutup overlay sementara (berfungsi sebagai pengingat berkala / reminder dengan jeda bertahap, bukan kurungan mati).
...
Untuk matriks pengujian lengkap kategori A–E dan format pelaporan temuan, buka:  
